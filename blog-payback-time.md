...
Yes we should, and some do! But how can we do that, not everyone at the office will be amused if we would fill our day with hobby projects and we can certainly not publish all our source code to the world. There are however a few options to balance it out. 
...
* Another option, and maybe the one that is the most comfortable one starting with is documentation. A lot of projects also accept changes in their docs, from simple things like correcting spelling or grammar to adding some examples. 

* You can also create a blogpost where you write down how you used some tech in your scenario, it can be useful for new team members but even for your future self.
